...
public class BaseBlockRender<B extends BlockOK, T extends TileEntityOK> {
    ...
    public void renderInventory(final B block, final ItemStack item, final RenderBlocks renderer,
        final IItemRenderer.ItemRenderType type, final Object[] data) {
        ...
        if (sides.contains(ForgeDirection.DOWN)) {
            ...
            renderer.renderFaceYNeg(
                ...
                this.firstNotNull(
                    ...
                    block.getRendererInstance()
                        .getTexture(ForgeDirection.DOWN),
        ...
        if (sides.contains(ForgeDirection.NORTH)) {
            ...
            renderer.renderFaceZNeg(
                ...
                this.firstNotNull(
                    renderer.overrideBlockTexture,
                    block.getRendererInstance()
                        .getTexture(ForgeDirection.NORTH),
        ...
        if (sides.contains(ForgeDirection.SOUTH)) {
            ...
            renderer.renderFaceZPos(
                ...
                this.firstNotNull(
                    renderer.overrideBlockTexture,
                    block.getRendererInstance()
                        .getTexture(ForgeDirection.SOUTH),
        ...
        if (sides.contains(ForgeDirection.WEST)) {
            ...
            renderer.renderFaceXNeg(
                ...
                this.firstNotNull(
                    renderer.overrideBlockTexture,
                    block.getRendererInstance()
                        .getTexture(ForgeDirection.WEST),
        ...
        if (sides.contains(ForgeDirection.EAST)) {
            ...
            renderer.renderFaceXPos(
                ...
                this.firstNotNull(
                    renderer.overrideBlockTexture,
                    block.getRendererInstance()
                        .getTexture(ForgeDirection.EAST),
    ...
    protected void applyTESRRotation(final double x, final double y, final double z, ForgeDirection forward,
        ...
        if (forward != null && up != null) {
            ...
            final ForgeDirection west = BlockHelpers.crossProduct(forward, up);
